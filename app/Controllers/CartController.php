...
class CartController extends Controller
{
    ...
    public function addCart(){
        ...
        if ($product['stock'] > 0) {
            ...
            return redirect()->to(base_url('/carrito'))->with('mensaje','Producto agregado');
        } else {
            $session = session();
            $session->setFlashdata('mensaje','sin stock disponible');
         return 
         
         $this->response->redirect(base_url('/catalogo'));
        }
